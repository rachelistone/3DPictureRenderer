...
public final class Vector {
	...
	public Vector crossProduct(Vector other) {
		Vector result = new Vector(_head._y._coord * other._head._z._coord - _head._z._coord * other._head._y._coord,
	...
	/**
	 * computes the length of the vector by finding the distance of the vector from
	 * the point (0, 0, 0)
	 * 
	...
	/**
	 * normalizes the vector to be in length 1 by dividing each coordinate of the
	 * head with the length of the vector
	 * 
	...
	/**
	 * normalizes the vector to be in length 1 by dividing each coordinate of the
	 * head with the length of the vector and returns the new vector
	 * 
	 * @return normalized vector
	 */
