...
public class SphereTest {
	...
	public void testFindIntersections() {
		...
		assertEquals("Ray not crosses sphere", List.of(p2), result);
		...
		assertEquals("Wrong number of points", 1, result.size());
		assertEquals("Ray not crosses the sphere at the right point", List.of(p2), result);
		...
		assertEquals("Wrong number of points", 1, result.size());
		assertEquals("Ray not crosses the sphere at the right point", List.of(new Point3D(1, 1, 0)), result);
